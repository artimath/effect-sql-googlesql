 ...
 * @since 1.0.0
 */
export declare const GoogleSqlCompiler: Context.Tag<Statement.Compiler, Statement.Compiler>;
/**
 * Builds a layer that installs a GoogleSQL compiler in the Effect context.
 *
 * @since 1.0.0
 */
export declare const layer: (options?: GoogleSqlCompilerOptions) => Layer.Layer<never, never, typeof GoogleSqlCompiler>;
